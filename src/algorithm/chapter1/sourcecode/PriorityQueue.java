...
public class PriorityQueue<E> extends AbstractQueue<E> implements java.io.Serializable {
	...
	/**
	 * Creates a {@code PriorityQueue} with the default initial capacity and whose
	 ...
	 *                   queue. If {@code null}, the {@linkplain Comparable natural
	 ...
	 *
	 * @param c the priority queue whose elements are to be placed into this
	 *          priority queue
	 * @throws ClassCastException   if elements of {@code c} cannot be compared to
	 *                              one another according to {@code c}'s ordering
	 * @throws NullPointerException if the specified priority queue or any of its
	 *                              elements are null
	 */
	@SuppressWarnings("unchecked")
	 ...
	 *
	 * @param c the sorted set whose elements are to be placed into this priority
	 *          queue
	 * @throws ClassCastException   if elements of the specified sorted set cannot
	 *                              be compared to one another according to the
	 *                              sorted set's ordering
	 * @throws NullPointerException if the specified sorted set or any of its
	 *                              elements are null
	 */
	@SuppressWarnings("unchecked")
...
//    }
	 ...
	 * <em>fail-fast</em> {@link Spliterator} over the elements in this queue.
	 *
	 * <p>
	 * The {@code Spliterator} reports {@link Spliterator#SIZED},
	 * {@link Spliterator#SUBSIZED}, and {@link Spliterator#NONNULL}. Overriding
	...
	static final class PriorityQueueSpliterator<E> implements Spliterator<E> {
		/*
		 * This is very similar to ArrayList Spliterator, except for extra null checks.
		 */
